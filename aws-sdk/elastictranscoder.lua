...
function M.JobOutput(_Status, _AppliedColorSpaceConversion, _Rotate, _Encryption, _AlbumArt, _FrameRate, _StatusDetail, _PresetId, _Height, _Width, _Watermarks, _SegmentDuration, _FileSize, _Key, _Captions, _Duration, _DurationMillis, _ThumbnailPattern, _ThumbnailEncryption, _Id, _Composition, ...)
	...
	local t = { 
		...
		["ThumbnailPattern"] = _ThumbnailPattern,
		["ThumbnailEncryption"] = _ThumbnailEncryption,
		["Id"] = _Id,
...
-- @param _Status [JobStatus] <p>To get information about all of the jobs associated with the current AWS account that have a given status, specify the following status: <code>Submitted</code>, <code>Progressing</code>, <code>Complete</code>, <code>Canceled</code>, or <code>Error</code>.</p>
-- @param _PageToken [Id] <p> When Elastic Transcoder returns more than one page of results, use <code>pageToken</code> in subsequent <code>GET</code> requests to get each successive page of results. </p>
-- @param _Ascending [Ascending] <p> To list jobs in chronological order by the date and time that they were submitted, enter <code>true</code>. To list jobs in reverse chronological order, enter <code>false</code>. </p>
-- Required parameter: Status
function M.ListJobsByStatusRequest(_Status, _PageToken, _Ascending, ...)
...
-- @param _Messages [ExceptionMessages] <p>If the <code>Success</code> element contains <code>false</code>, this value is an array of one or more error messages that were generated during the test process.</p>
-- @param _Success [Success] <p>If the operation is successful, this value is <code>true</code>; otherwise, the value is <code>false</code>.</p>
function M.TestRoleResponse(_Messages, _Success, ...)
...
-- @param _NextPageToken [Id] <p> A value that you use to access the second and subsequent pages of results, if any. When the jobs in the specified pipeline fit on one page or when you've reached the last page of results, the value of <code>NextPageToken</code> is <code>null</code>. </p>
-- @param _Jobs [Jobs] <p>An array of <code>Job</code> objects that have the specified status.</p>
function M.ListJobsByStatusResponse(_NextPageToken, _Jobs, ...)
...
-- @param _Preset [Preset] <p>A section of the response body that provides information about the preset.</p>
function M.ReadPresetResponse(_Preset, ...)
...
-- @param _Completed [SnsTopic] <p>The Amazon SNS topic that you want to notify when Elastic Transcoder has finished processing the job.</p>
-- @param _Warning [SnsTopic] <p>The Amazon SNS topic that you want to notify when Elastic Transcoder encounters a warning condition.</p>
-- @param _Progressing [SnsTopic] <p>The Amazon Simple Notification Service (Amazon SNS) topic that you want to notify when Elastic Transcoder has started to process the job.</p>
-- @param _Error [SnsTopic] <p>The Amazon SNS topic that you want to notify when Elastic Transcoder encounters an error condition.</p>
function M.Notifications(_Completed, _Warning, _Progressing, _Error, ...)
...
-- @param _Thumbnails [Thumbnails] <p>A section of the response body that provides information about the thumbnail preset values, if any.</p>
-- @param _Container [PresetContainer] <p>The container type for the output file. Valid values include <code>flac</code>, <code>flv</code>, <code>fmp4</code>, <code>gif</code>, <code>mp3</code>, <code>mp4</code>, <code>mpg</code>, <code>mxf</code>, <code>oga</code>, <code>ogg</code>, <code>ts</code>, and <code>webm</code>.</p>
-- @param _Description [Description] <p>A description of the preset.</p>
-- @param _Video [VideoParameters] <p>A section of the response body that provides information about the video preset values.</p>
-- @param _Audio [AudioParameters] <p>A section of the response body that provides information about the audio preset values.</p>
-- @param _Type [PresetType] <p>Whether the preset is a default preset provided by Elastic Transcoder (<code>System</code>) or a preset that you have defined (<code>Custom</code>).</p>
-- @param _Id [Id] <p>Identifier for the new preset. You use this value to get settings for the preset or to delete it.</p>
-- @param _Arn [String] <p>The Amazon Resource Name (ARN) for the preset.</p>
-- @param _Name [Name] <p>The name of the preset.</p>
function M.Preset(_Thumbnails, _Container, _Description, _Video, _Audio, _Type, _Id, _Arn, _Name, ...)
...
-- @param _FinishTimeMillis [NullableLong] <p>The time the job finished transcoding, in epoch milliseconds.</p>
-- @param _SubmitTimeMillis [NullableLong] <p>The time the job was submitted to Elastic Transcoder, in epoch milliseconds.</p>
-- @param _StartTimeMillis [NullableLong] <p>The time the job began transcoding, in epoch milliseconds.</p>
function M.Timing(_FinishTimeMillis, _SubmitTimeMillis, _StartTimeMillis, ...)
	assert(select("#", ...) == 0, "Too many arguments when creating Timing")
	local t = { 
		["FinishTimeMillis"] = _FinishTimeMillis,
		["SubmitTimeMillis"] = _SubmitTimeMillis,
...
-- @param _Message [String] <p>The message explaining what resources are in a different region from the pipeline.</p> <note> <p>AWS KMS keys must be in the same region as the pipeline.</p> </note>
-- @param _Code [String] <p>The code of the cross-regional warning.</p>
function M.Warning(_Message, _Code, ...)
...
-- @param _Profile [AudioCodecProfile] <p>You can only choose an audio profile when you specify AAC for the value of Audio:Codec.</p> <p>Specify the AAC profile for the output file. Elastic Transcoder supports the following profiles:</p> <ul> <li> <p> <code>auto</code>: If you specify <code>auto</code>, Elastic Transcoder selects the profile based on the bit rate selected for the output file.</p> </li> <li> <p> <code>AAC-LC</code>: The most common AAC profile. Use for bit rates larger than 64 kbps.</p> </li> <li> <p> <code>HE-AAC</code>: Not supported on some older players and devices. Use for bit rates between 40 and 80 kbps.</p> </li> <li> <p> <code>HE-AACv2</code>: Not supported on some players and devices. Use for bit rates less than 48 kbps.</p> </li> </ul> <p>All outputs in a <code>Smooth</code> playlist must have the same value for <code>Profile</code>.</p> <note> <p>If you created any presets before AAC profiles were added, Elastic Transcoder automatically updated your presets to use AAC-LC. You can change the value as required.</p> </note>
-- @param _BitDepth [AudioBitDepth] <p>You can only choose an audio bit depth when you specify <code>flac</code> or <code>pcm</code> for the value of Audio:Codec.</p> <p>The bit depth of a sample is how many bits of information are included in the audio samples. The higher the bit depth, the better the audio, but the larger the file.</p> <p>Valid values are <code>16</code> and <code>24</code>.</p> <p>The most common bit depth is <code>24</code>.</p>
-- @param _Signed [AudioSigned] <p>You can only choose whether an audio sample is signed when you specify <code>pcm</code> for the value of Audio:Codec.</p> <p>Whether audio samples are represented with negative and positive numbers (signed) or only positive numbers (unsigned).</p> <p>The supported value is <code>Signed</code>.</p>
-- @param _BitOrder [AudioBitOrder] <p>You can only choose an audio bit order when you specify <code>pcm</code> for the value of Audio:Codec.</p> <p>The order the bits of a PCM sample are stored in.</p> <p>The supported value is <code>LittleEndian</code>.</p>
function M.AudioCodecOptions(_Profile, _BitDepth, _Signed, _BitOrder, ...)
...
-- @param _NextPageToken [Id] <p>A value that you use to access the second and subsequent pages of results, if any. When the presets fit on one page or when you've reached the last page of results, the value of <code>NextPageToken</code> is <code>null</code>.</p>
-- @param _Presets [Presets] <p>An array of <code>Preset</code> objects.</p>
function M.ListPresetsResponse(_NextPageToken, _Presets, ...)
...
-- @param _NextPageToken [Id] <p> A value that you use to access the second and subsequent pages of results, if any. When the jobs in the specified pipeline fit on one page or when you've reached the last page of results, the value of <code>NextPageToken</code> is <code>null</code>. </p>
-- @param _Jobs [Jobs] <p>An array of <code>Job</code> objects that are in the specified pipeline.</p>
function M.ListJobsByPipelineResponse(_NextPageToken, _Jobs, ...)
...
-- @param _Job [Job] <p>A section of the response body that provides information about the job that is created.</p>
function M.CreateJobResponse(_Job, ...)
...
-- @param _KeyMd5 [Base64EncodedString] <p>If Elastic Transcoder is generating your key for you, you must leave this field blank.</p> <p>The MD5 digest of the key that you want Elastic Transcoder to use to encrypt your output file, and that you want Elastic Transcoder to use as a checksum to make sure your key was not corrupted in transit. The key MD5 must be base64-encoded, and it must be exactly 16 bytes before being base64- encoded.</p>
-- @param _KeyStoragePolicy [KeyStoragePolicy] <p>Specify whether you want Elastic Transcoder to write your HLS license key to an Amazon S3 bucket. If you choose <code>WithVariantPlaylists</code>, <code>LicenseAcquisitionUrl</code> must be left blank and Elastic Transcoder writes your data key into the same bucket as the associated playlist.</p>
-- @param _InitializationVector [ZeroTo255String] <p>If Elastic Transcoder is generating your key for you, you must leave this field blank.</p> <p>The series of random bits created by a random bit generator, unique for every encryption operation, that you want Elastic Transcoder to use to encrypt your output files. The initialization vector must be base64-encoded, and it must be exactly 16 bytes before being base64-encoded.</p>
-- @param _LicenseAcquisitionUrl [ZeroTo512String] <p>The location of the license key required to decrypt your HLS playlist. The URL must be an absolute path, and is referenced in the URI attribute of the EXT-X-KEY metadata tag in the playlist file.</p>
...
-- @param _Method [HlsContentProtectionMethod] <p>The content protection method for your output. The only valid value is: <code>aes-128</code>.</p> <p>This value is written into the method attribute of the <code>EXT-X-KEY</code> metadata tag in the output playlist.</p>
function M.HlsContentProtection(_KeyMd5, _KeyStoragePolicy, _InitializationVector, _LicenseAcquisitionUrl, _Key, _Method, ...)
	assert(select("#", ...) == 0, "Too many arguments when creating HlsContentProtection")
	local t = { 
		["KeyMd5"] = _KeyMd5,
		["KeyStoragePolicy"] = _KeyStoragePolicy,
		["InitializationVector"] = _InitializationVector,
		["LicenseAcquisitionUrl"] = _LicenseAcquisitionUrl,
		["Key"] = _Key,
		["Method"] = _Method,
	}
...
-- @param _Container [PresetContainer] <p>The container type for the output file. Valid values include <code>flac</code>, <code>flv</code>, <code>fmp4</code>, <code>gif</code>, <code>mp3</code>, <code>mp4</code>, <code>mpg</code>, <code>mxf</code>, <code>oga</code>, <code>ogg</code>, <code>ts</code>, and <code>webm</code>.</p>
-- @param _Thumbnails [Thumbnails] <p>A section of the request body that specifies the thumbnail parameters, if any.</p>
-- @param _Video [VideoParameters] <p>A section of the request body that specifies the video parameters.</p>
-- @param _Description [Description] <p>A description of the preset.</p>
-- @param _Audio [AudioParameters] <p>A section of the request body that specifies the audio parameters.</p>
-- @param _Name [Name] <p>The name of the preset. We recommend that the name be unique within the AWS account, but uniqueness is not enforced.</p>
-- Required parameter: Name
-- Required parameter: Container
function M.CreatePresetRequest(_Container, _Thumbnails, _Video, _Description, _Audio, _Name, ...)
...
-- @param _Status [JobStatus] <p> The status of the job: <code>Submitted</code>, <code>Progressing</code>, <code>Complete</code>, <code>Canceled</code>, or <code>Error</code>. </p>
-- @param _Inputs [JobInputs] <p>Information about the files that you're transcoding. If you specified multiple files for this job, Elastic Transcoder stitches the files together to make one output.</p>
-- @param _Playlists [Playlists] <important> <p>Outputs in Fragmented MP4 or MPEG-TS format only.</p> </important> <p>If you specify a preset in <code>PresetId</code> for which the value of <code>Container</code> is fmp4 (Fragmented MP4) or ts (MPEG-TS), <code>Playlists</code> contains information about the master playlists that you want Elastic Transcoder to create.</p> <p>The maximum number of master playlists in a job is 30.</p>
-- @param _Outputs [JobOutputs] <p>Information about the output files. We recommend that you use the <code>Outputs</code> syntax for all jobs, even when you want Elastic Transcoder to transcode a file into only one format. Do not use both the <code>Outputs</code> and <code>Output</code> syntaxes in the same request. You can create a maximum of 30 outputs per job. </p> <p>If you specify more than one output for a job, Elastic Transcoder creates the files for each output in the order in which you specify them in the job.</p>
-- @param _PipelineId [Id] <p> The <code>Id</code> of the pipeline that you want Elastic Transcoder to use for transcoding. The pipeline determines several settings, including the Amazon S3 bucket from which Elastic Transcoder gets the files to transcode and the bucket into which Elastic Transcoder puts the transcoded files. </p>
-- @param _OutputKeyPrefix [Key] <p>The value, if any, that you want Elastic Transcoder to prepend to the names of all files that this job creates, including output files, thumbnails, and playlists. We recommend that you add a / or some other delimiter to the end of the <code>OutputKeyPrefix</code>.</p>
-- @param _UserMetadata [UserMetadata] <p>User-defined metadata that you want to associate with an Elastic Transcoder job. You specify metadata in <code>key/value</code> pairs, and you can add up to 10 <code>key/value</code> pairs per job. Elastic Transcoder does not guarantee that <code>key/value</code> pairs are returned in the same order in which you specify them.</p> <p>Metadata <code>keys</code> and <code>values</code> must use characters from the following list:</p> <ul> <li> <p> <code>0-9</code> </p> </li> <li> <p> <code>A-Z</code> and <code>a-z</code> </p> </li> <li> <p> <code>Space</code> </p> </li> <li> <p>The following symbols: <code>_.:/=+-%@</code> </p> </li> </ul>
-- @param _Output [JobOutput] <p>If you specified one output for a job, information about that output. If you specified multiple outputs for a job, the Output object lists information about the first output. This duplicates the information that is listed for the first output in the Outputs object.</p> <important> <p>Outputs recommended instead.</p> </important> <p>A section of the request or response body that provides information about the transcoded (target) file. </p>
-- @param _Timing [Timing] <p>Details about the timing of a job.</p>
-- @param _Input [JobInput] <p>A section of the request or response body that provides information about the file that is being transcoded.</p>
-- @param _Id [Id] <p>The identifier that Elastic Transcoder assigned to the job. You use this value to get settings for the job or to delete the job.</p>
-- @param _Arn [String] <p>The Amazon Resource Name (ARN) for the job.</p>
function M.Job(_Status, _Inputs, _Playlists, _Outputs, _PipelineId, _OutputKeyPrefix, _UserMetadata, _Output, _Timing, _Input, _Id, _Arn, ...)
	...
	local t = { 
		...
		["OutputKeyPrefix"] = _OutputKeyPrefix,
...
-- @param _PageToken [Id] <p>When Elastic Transcoder returns more than one page of results, use <code>pageToken</code> in subsequent <code>GET</code> requests to get each successive page of results. </p>
-- @param _Ascending [Ascending] <p>To list pipelines in chronological order by the date and time that they were created, enter <code>true</code>. To list pipelines in reverse chronological order, enter <code>false</code>.</p>
function M.ListPipelinesRequest(_PageToken, _Ascending, ...)
...
-- @param _PageToken [Id] <p>When Elastic Transcoder returns more than one page of results, use <code>pageToken</code> in subsequent <code>GET</code> requests to get each successive page of results. </p>
-- @param _Ascending [Ascending] <p>To list presets in chronological order by the date and time that they were created, enter <code>true</code>. To list presets in reverse chronological order, enter <code>false</code>.</p>
function M.ListPresetsRequest(_PageToken, _Ascending, ...)
...
-- @param _Pipeline [Pipeline] <p>The pipeline updated by this <code>UpdatePipelineResponse</code> call.</p>
-- @param _Warnings [Warnings] <p>Elastic Transcoder returns a warning if the resources used by your pipeline are not in the same region as the pipeline.</p> <p>Using resources in the same region, such as your Amazon S3 buckets, Amazon SNS notification topics, and AWS KMS key, reduces processing time and prevents cross-regional charges.</p>
function M.UpdatePipelineResponse(_Pipeline, _Warnings, ...)
...
-- @param _Width [NullableInteger] <p>The detected width of the input file, in pixels.</p>
-- @param _DurationMillis [NullableLong] <p>The detected duration of the input file, in milliseconds.</p>
-- @param _FrameRate [FloatString] <p>The detected frame rate of the input file, in frames per second.</p>
-- @param _FileSize [NullableLong] <p>The detected file size of the input file, in bytes.</p>
-- @param _Height [NullableInteger] <p>The detected height of the input file, in pixels.</p>
function M.DetectedProperties(_Width, _DurationMillis, _FrameRate, _FileSize, _Height, ...)
...
-- @param _TimeSpan [TimeSpan] <p>Settings that determine when a clip begins and how long it lasts.</p>
function M.Clip(_TimeSpan, ...)
...
function M.VideoParameters(_SizingPolicy, _MaxWidth, _PaddingPolicy, _Resolution, _MaxFrameRate, _FrameRate, _MaxHeight, _KeyframesMaxDist, _FixedGOP, _Codec, _Watermarks, _CodecOptions, _AspectRatio, _BitRate, _DisplayAspectRatio, ...)
	...
	local t = { 
		...
		["FrameRate"] = _FrameRate,
		["MaxHeight"] = _MaxHeight,
		["KeyframesMaxDist"] = _KeyframesMaxDist,
		["FixedGOP"] = _FixedGOP,
		["Codec"] = _Codec,
		["Watermarks"] = _Watermarks,
...
-- @param _Status [PipelineStatus] <p>The desired status of the pipeline:</p> <ul> <li> <p> <code>Active</code>: The pipeline is processing jobs.</p> </li> <li> <p> <code>Paused</code>: The pipeline is not currently processing jobs.</p> </li> </ul>
-- @param _Id [Id] <p>The identifier of the pipeline to update.</p>
-- Required parameter: Id
-- Required parameter: Status
function M.UpdatePipelineStatusRequest(_Status, _Id, ...)
...
-- @param _Id [Id] <p>The identifier of the job for which you want to get detailed information.</p>
-- Required parameter: Id
function M.ReadJobRequest(_Id, ...)
...
-- @param _AlbumArtFormat [JpgOrPng] <p>The format of album art, if any. Valid formats are <code>.jpg</code> and <code>.png</code>.</p>
-- @param _MaxWidth [DigitsOrAuto] <p>The maximum width of the output album art in pixels. If you specify <code>auto</code>, Elastic Transcoder uses 600 as the default value. If you specify a numeric value, enter an even integer between 32 and 4096, inclusive.</p>
-- @param _PaddingPolicy [PaddingPolicy] <p>When you set <code>PaddingPolicy</code> to <code>Pad</code>, Elastic Transcoder may add white bars to the top and bottom and/or left and right sides of the output album art to make the total size of the output art match the values that you specified for <code>MaxWidth</code> and <code>MaxHeight</code>.</p>
-- @param _Encryption [Encryption] <p>The encryption settings, if any, that you want Elastic Transcoder to apply to your artwork.</p>
-- @param _MaxHeight [DigitsOrAuto] <p>The maximum height of the output album art in pixels. If you specify <code>auto</code>, Elastic Transcoder uses 600 as the default value. If you specify a numeric value, enter an even integer between 32 and 3072, inclusive.</p>
-- @param _InputKey [WatermarkKey] <p>The name of the file to be used as album art. To determine which Amazon S3 bucket contains the specified file, Elastic Transcoder checks the pipeline specified by <code>PipelineId</code>; the <code>InputBucket</code> object in that pipeline identifies the bucket.</p> <p>If the file name includes a prefix, for example, <code>cooking/pie.jpg</code>, include the prefix in the key. If the file isn't in the specified bucket, Elastic Transcoder returns an error.</p>
function M.Artwork(_SizingPolicy, _AlbumArtFormat, _MaxWidth, _PaddingPolicy, _Encryption, _MaxHeight, _InputKey, ...)
	assert(select("#", ...) == 0, "Too many arguments when creating Artwork")
	local t = { 
		["SizingPolicy"] = _SizingPolicy,
		["AlbumArtFormat"] = _AlbumArtFormat,
		["MaxWidth"] = _MaxWidth,
		["PaddingPolicy"] = _PaddingPolicy,
		["Encryption"] = _Encryption,
		["MaxHeight"] = _MaxHeight,
...
-- @param _Notifications [Notifications] <p>The topic ARN for the Amazon Simple Notification Service (Amazon SNS) topic that you want to notify to report job status.</p> <important> <p>To receive notifications, you must also subscribe to the new topic in the Amazon SNS console.</p> </important> <ul> <li> <p> <b>Progressing</b>: The topic ARN for the Amazon Simple Notification Service (Amazon SNS) topic that you want to notify when Elastic Transcoder has started to process jobs that are added to this pipeline. This is the ARN that Amazon SNS returned when you created the topic.</p> </li> <li> <p> <b>Completed</b>: The topic ARN for the Amazon SNS topic that you want to notify when Elastic Transcoder has finished processing a job. This is the ARN that Amazon SNS returned when you created the topic.</p> </li> <li> <p> <b>Warning</b>: The topic ARN for the Amazon SNS topic that you want to notify when Elastic Transcoder encounters a warning condition. This is the ARN that Amazon SNS returned when you created the topic.</p> </li> <li> <p> <b>Error</b>: The topic ARN for the Amazon SNS topic that you want to notify when Elastic Transcoder encounters an error condition. This is the ARN that Amazon SNS returned when you created the topic.</p> </li> </ul>
-- @param _AwsKmsKeyArn [KeyArn] <p>The AWS Key Management Service (AWS KMS) key that you want to use with this pipeline.</p> <p>If you use either <code>S3</code> or <code>S3-AWS-KMS</code> as your <code>Encryption:Mode</code>, you don't need to provide a key with your job because a default key, known as an AWS-KMS key, is created for you automatically. You need to provide an AWS-KMS key only if you want to use a non-default AWS-KMS key, or if you are using an <code>Encryption:Mode</code> of <code>AES-PKCS7</code>, <code>AES-CTR</code>, or <code>AES-GCM</code>.</p>
-- @param _InputBucket [BucketName] <p>The Amazon S3 bucket in which you saved the media files that you want to transcode and the graphics that you want to use as watermarks.</p>
-- @param _Role [Role] <p>The IAM Amazon Resource Name (ARN) for the role that you want Elastic Transcoder to use to transcode jobs for this pipeline.</p>
-- @param _Id [Id] <p>The ID of the pipeline that you want to update.</p>
-- Required parameter: Id
function M.UpdatePipelineRequest(_ContentConfig, _ThumbnailConfig, _Name, _Notifications, _AwsKmsKeyArn, _InputBucket, _Role, _Id, ...)
...
-- @param _TimeOffset [TimeOffset] <p>For clip generation or captions that do not start at the same time as the associated video file, the <code>TimeOffset</code> tells Elastic Transcoder how much of the video to encode before including captions.</p> <p>Specify the TimeOffset in the form [+-]SS.sss or [+-]HH:mm:SS.ss.</p>
-- @param _Encryption [Encryption] <p>The encryption settings, if any, that Elastic Transcoder needs to decyrpt your caption sources, or that you want Elastic Transcoder to apply to your caption sources.</p>
-- @param _Language [Key] <p>A string that specifies the language of the caption. If you specified multiple inputs with captions, the caption language must match in order to be included in the output. Specify this as one of:</p> <ul> <li> <p>2-character ISO 639-1 code</p> </li> <li> <p>3-character ISO 639-2 code</p> </li> </ul> <p>For more information on ISO language codes and language names, see the List of ISO 639-1 codes.</p>
-- @param _Key [LongKey] <p>The name of the sidecar caption file that you want Elastic Transcoder to include in the output file.</p>
-- @param _Label [Name] <p>The label of the caption shown in the player when choosing a language. We recommend that you put the caption language name here, in the language of the captions.</p>
function M.CaptionSource(_TimeOffset, _Encryption, _Language, _Key, _Label, ...)
...
-- @param _Id [Id] <p>The identifier of the preset for which you want to get detailed information.</p>
-- Required parameter: Id
function M.DeletePresetRequest(_Id, ...)
...
-- @param _Id [Id] <p>The identifier of the pipeline that you want to delete.</p>
-- Required parameter: Id
function M.DeletePipelineRequest(_Id, ...)
...
-- @param _Pipeline [Pipeline] <p>A section of the response body that provides information about the pipeline associated with this notification.</p>
function M.UpdatePipelineNotificationsResponse(_Pipeline, ...)
...
-- @param _MergePolicy [CaptionMergePolicy] <p>A policy that determines how Elastic Transcoder handles the existence of multiple captions.</p> <ul> <li> <p> <b>MergeOverride:</b> Elastic Transcoder transcodes both embedded and sidecar captions into outputs. If captions for a language are embedded in the input file and also appear in a sidecar file, Elastic Transcoder uses the sidecar captions and ignores the embedded captions for that language.</p> </li> <li> <p> <b>MergeRetain:</b> Elastic Transcoder transcodes both embedded and sidecar captions into outputs. If captions for a language are embedded in the input file and also appear in a sidecar file, Elastic Transcoder uses the embedded captions and ignores the sidecar captions for that language. If <code>CaptionSources</code> is empty, Elastic Transcoder omits all sidecar captions from the output files.</p> </li> <li> <p> <b>Override:</b> Elastic Transcoder transcodes only the sidecar captions that you specify in <code>CaptionSources</code>.</p> </li> </ul> <p> <code>MergePolicy</code> cannot be null.</p>
-- @param _CaptionSources [CaptionSources] <p>Source files for the input sidecar captions used during the transcoding process. To omit all sidecar captions, leave <code>CaptionSources</code> blank.</p>
-- @param _CaptionFormats [CaptionFormats] <p>The array of file formats for the output captions. If you leave this value blank, Elastic Transcoder returns an error.</p>
function M.Captions(_MergePolicy, _CaptionSources, _CaptionFormats, ...)
	assert(select("#", ...) == 0, "Too many arguments when creating Captions")
	local t = { 
		["MergePolicy"] = _MergePolicy,
		["CaptionSources"] = _CaptionSources,
		["CaptionFormats"] = _CaptionFormats,
	}
...
-- @param _PageToken [Id] <p> When Elastic Transcoder returns more than one page of results, use <code>pageToken</code> in subsequent <code>GET</code> requests to get each successive page of results. </p>
-- @param _PipelineId [Id] <p>The ID of the pipeline for which you want to get job information.</p>
-- @param _Ascending [Ascending] <p> To list jobs in chronological order by the date and time that they were submitted, enter <code>true</code>. To list jobs in reverse chronological order, enter <code>false</code>. </p>
-- Required parameter: PipelineId
function M.ListJobsByPipelineRequest(_PageToken, _PipelineId, _Ascending, ...)
...
-- @param _StartTime [Time] <p>The place in the input file where you want a clip to start. The format can be either HH:mm:ss.SSS (maximum value: 23:59:59.999; SSS is thousandths of a second) or sssss.SSS (maximum value: 86399.999). If you don't specify a value, Elastic Transcoder starts at the beginning of the input file.</p>
function M.TimeSpan(_Duration, _StartTime, ...)
...
-- @param _Inputs [JobInputs] <p>A section of the request body that provides information about the files that are being transcoded.</p>
-- @param _Playlists [CreateJobPlaylists] <p>If you specify a preset in <code>PresetId</code> for which the value of <code>Container</code> is fmp4 (Fragmented MP4) or ts (MPEG-TS), Playlists contains information about the master playlists that you want Elastic Transcoder to create.</p> <p>The maximum number of master playlists in a job is 30.</p>
-- @param _Outputs [CreateJobOutputs] <p> A section of the request body that provides information about the transcoded (target) files. We recommend that you use the <code>Outputs</code> syntax instead of the <code>Output</code> syntax. </p>
-- @param _PipelineId [Id] <p>The <code>Id</code> of the pipeline that you want Elastic Transcoder to use for transcoding. The pipeline determines several settings, including the Amazon S3 bucket from which Elastic Transcoder gets the files to transcode and the bucket into which Elastic Transcoder puts the transcoded files.</p>
-- @param _OutputKeyPrefix [Key] <p>The value, if any, that you want Elastic Transcoder to prepend to the names of all files that this job creates, including output files, thumbnails, and playlists.</p>
-- @param _UserMetadata [UserMetadata] <p>User-defined metadata that you want to associate with an Elastic Transcoder job. You specify metadata in <code>key/value</code> pairs, and you can add up to 10 <code>key/value</code> pairs per job. Elastic Transcoder does not guarantee that <code>key/value</code> pairs are returned in the same order in which you specify them.</p>
-- @param _Output [CreateJobOutput] <p> A section of the request body that provides information about the transcoded (target) file. We strongly recommend that you use the <code>Outputs</code> syntax instead of the <code>Output</code> syntax. </p>
-- @param _Input [JobInput] <p>A section of the request body that provides information about the file that is being transcoded.</p>
-- Required parameter: PipelineId
function M.CreateJobRequest(_Inputs, _Playlists, _Outputs, _PipelineId, _OutputKeyPrefix, _UserMetadata, _Output, _Input, ...)
...
-- @param _Role [Role] <p>The IAM Amazon Resource Name (ARN) for the role that Elastic Transcoder uses to transcode jobs for this pipeline.</p>
-- @param _InputBucket [BucketName] <p>The Amazon S3 bucket from which Elastic Transcoder gets media files for transcoding and the graphics files, if any, that you want to use for watermarks.</p>
-- @param _OutputBucket [BucketName] <p>The Amazon S3 bucket in which you want Elastic Transcoder to save transcoded files, thumbnails, and playlists. Either you specify this value, or you specify both <code>ContentConfig</code> and <code>ThumbnailConfig</code>.</p>
-- @param _Id [Id] <p>The identifier for the pipeline. You use this value to identify the pipeline in which you want to perform a variety of operations, such as creating a job or a preset.</p>
-- @param _Arn [String] <p>The Amazon Resource Name (ARN) for the pipeline.</p>
function M.Pipeline(_Status, _ContentConfig, _Name, _ThumbnailConfig, _AwsKmsKeyArn, _Notifications, _Role, _InputBucket, _OutputBucket, _Id, _Arn, ...)
...
-- @param _KeyId [KeyIdGuid] <p>The ID for your DRM key, so that your DRM license provider knows which key to provide.</p> <p>The key ID must be provided in big endian, and Elastic Transcoder converts it to little endian before inserting it into the PlayReady DRM headers. If you are unsure whether your license server provides your key ID in big or little endian, check with your DRM provider.</p>
-- @param _KeyMd5 [NonEmptyBase64EncodedString] <p>The MD5 digest of the key used for DRM on your file, and that you want Elastic Transcoder to use as a checksum to make sure your key was not corrupted in transit. The key MD5 must be base64-encoded, and it must be exactly 16 bytes before being base64-encoded.</p>
-- @param _Format [PlayReadyDrmFormatString] <p>The type of DRM, if any, that you want Elastic Transcoder to apply to the output files associated with this playlist.</p>
-- @param _InitializationVector [ZeroTo255String] <p>The series of random bits created by a random bit generator, unique for every encryption operation, that you want Elastic Transcoder to use to encrypt your files. The initialization vector must be base64-encoded, and it must be exactly 8 bytes long before being base64-encoded. If no initialization vector is provided, Elastic Transcoder generates one for you.</p>
-- @param _LicenseAcquisitionUrl [OneTo512String] <p>The location of the license key required to play DRM content. The URL must be an absolute path, and is referenced by the PlayReady header. The PlayReady header is referenced in the protection header of the client manifest for Smooth Streaming outputs, and in the EXT-X-DXDRM and EXT-XDXDRMINFO metadata tags for HLS playlist outputs. An example URL looks like this: <code>https://www.example.com/exampleKey/</code> </p>
-- @param _Key [NonEmptyBase64EncodedString] <p>The DRM key for your file, provided by your DRM license provider. The key must be base64-encoded, and it must be one of the following bit lengths before being base64-encoded:</p> <p> <code>128</code>, <code>192</code>, or <code>256</code>. </p> <p>The key must also be encrypted by using AWS KMS.</p>
function M.PlayReadyDrm(_KeyId, _KeyMd5, _Format, _InitializationVector, _LicenseAcquisitionUrl, _Key, ...)
...
-- @param _Pipeline [Pipeline] <p>A section of the response body that provides information about the pipeline that is created.</p>
-- @param _Warnings [Warnings] <p>Elastic Transcoder returns a warning if the resources used by your pipeline are not in the same region as the pipeline.</p> <p>Using resources in the same region, such as your Amazon S3 buckets, Amazon SNS notification topics, and AWS KMS key, reduces processing time and prevents cross-regional charges.</p>
function M.CreatePipelineResponse(_Pipeline, _Warnings, ...)
...
-- @param _Encryption [Encryption] <p>You can specify encryption settings for any output files that you want to use for a transcoding job. This includes the output file and any watermarks, thumbnails, album art, or captions that you want to use. You must specify encryption settings for each file individually.</p>
-- @param _PresetId [Id] <p> The <code>Id</code> of the preset to use for this job. The preset determines the audio, video, and thumbnail settings that Elastic Transcoder uses for transcoding. </p>
-- @param _Watermarks [JobWatermarks] <p>Information about the watermarks that you want Elastic Transcoder to add to the video during transcoding. You can specify up to four watermarks for each output. Settings for each watermark must be defined in the preset for the current output.</p>
...
-- @param _Captions [Captions] <p>You can configure Elastic Transcoder to transcode captions, or subtitles, from one format to another. All captions must be in UTF-8. Elastic Transcoder supports two types of captions:</p> <ul> <li> <p> <b>Embedded:</b> Embedded captions are included in the same file as the audio and video. Elastic Transcoder supports only one embedded caption per language, to a maximum of 300 embedded captions per file.</p> <p>Valid input values include: <code>CEA-608 (EIA-608</code>, first non-empty channel only), <code>CEA-708 (EIA-708</code>, first non-empty channel only), and <code>mov-text</code> </p> <p>Valid outputs include: <code>mov-text</code> </p> <p>Elastic Transcoder supports a maximum of one embedded format per output.</p> </li> <li> <p> <b>Sidecar:</b> Sidecar captions are kept in a separate metadata file from the audio and video data. Sidecar captions require a player that is capable of understanding the relationship between the video file and the sidecar file. Elastic Transcoder supports only one sidecar caption per language, to a maximum of 20 sidecar captions per file.</p> <p>Valid input values include: <code>dfxp</code> (first div element only), <code>ebu-tt</code>, <code>scc</code>, <code>smpt</code>, <code>srt</code>, <code>ttml</code> (first div element only), and <code>webvtt</code> </p> <p>Valid outputs include: <code>dfxp</code> (first div element only), <code>scc</code>, <code>srt</code>, and <code>webvtt</code>.</p> </li> </ul> <p>If you want ttml or smpte-tt compatible captions, specify dfxp as your output format.</p> <p>Elastic Transcoder does not support OCR (Optical Character Recognition), does not accept pictures as a valid input for captions, and is not available for audio-only transcoding. Elastic Transcoder does not preserve text formatting (for example, italics) during the transcoding process.</p> <p>To remove captions or leave the captions empty, set <code>Captions</code> to null. To pass through existing captions unchanged, set the <code>MergePolicy</code> to <code>MergeRetain</code>, and pass in a null <code>CaptionSources</code> array.</p> <p>For more information on embedded files, see the Subtitles Wikipedia page.</p> <p>For more information on sidecar files, see the Extensible Metadata Platform and Sidecar file Wikipedia pages.</p>
-- @param _AlbumArt [JobAlbumArt] <p>Information about the album art that you want Elastic Transcoder to add to the file during transcoding. You can specify up to twenty album artworks for each output. Settings for each artwork must be defined in the job for the current output.</p>
-- @param _ThumbnailPattern [ThumbnailPattern] <p>Whether you want Elastic Transcoder to create thumbnails for your videos and, if so, how you want Elastic Transcoder to name the files.</p> <p>If you don't want Elastic Transcoder to create thumbnails, specify "".</p> <p>If you do want Elastic Transcoder to create thumbnails, specify the information that you want to include in the file name for each thumbnail. You can specify the following values in any sequence:</p> <ul> <li> <p> <b> <code>{count}</code> (Required)</b>: If you want to create thumbnails, you must include <code>{count}</code> in the <code>ThumbnailPattern</code> object. Wherever you specify <code>{count}</code>, Elastic Transcoder adds a five-digit sequence number (beginning with <b>00001</b>) to thumbnail file names. The number indicates where a given thumbnail appears in the sequence of thumbnails for a transcoded file. </p> <important> <p>If you specify a literal value and/or <code>{resolution}</code> but you omit <code>{count}</code>, Elastic Transcoder returns a validation error and does not create the job.</p> </important> </li> <li> <p> <b>Literal values (Optional)</b>: You can specify literal values anywhere in the <code>ThumbnailPattern</code> object. For example, you can include them as a file name prefix or as a delimiter between <code>{resolution}</code> and <code>{count}</code>. </p> </li> <li> <p> <b> <code>{resolution}</code> (Optional)</b>: If you want Elastic Transcoder to include the resolution in the file name, include <code>{resolution}</code> in the <code>ThumbnailPattern</code> object. </p> </li> </ul> <p>When creating thumbnails, Elastic Transcoder automatically saves the files in the format (.jpg or .png) that appears in the preset that you specified in the <code>PresetID</code> value of <code>CreateJobOutput</code>. Elastic Transcoder also appends the applicable file name extension.</p>
-- @param _ThumbnailEncryption [Encryption] <p>The encryption settings, if any, that you want Elastic Transcoder to apply to your thumbnail.</p>
-- @param _Composition [Composition] <p>You can create an output file that contains an excerpt from the input file. This excerpt, called a clip, can come from the beginning, middle, or end of the file. The Composition object contains settings for the clips that make up an output file. For the current release, you can only specify settings for a single clip per output file. The Composition object cannot be null.</p>
function M.CreateJobOutput(_Rotate, _Encryption, _PresetId, _Watermarks, _SegmentDuration, _Key, _Captions, _AlbumArt, _ThumbnailPattern, _ThumbnailEncryption, _Composition, ...)
...
-- @param _Job [Job] <p>A section of the response body that provides information about the job.</p>
function M.ReadJobResponse(_Job, ...)
...
-- @param _Id [Id] <p>The identifier of the preset for which you want to get detailed information.</p>
-- Required parameter: Id
function M.ReadPresetRequest(_Id, ...)
...
-- @param _Id [Id] <p>The identifier of the pipeline to read.</p>
-- Required parameter: Id
function M.ReadPipelineRequest(_Id, ...)
...
-- @param _OutputBucket [BucketName] <p>The Amazon S3 bucket that Elastic Transcoder writes transcoded media files to. The action attempts to read from this bucket.</p>
-- @param _Topics [SnsTopics] <p>The ARNs of one or more Amazon Simple Notification Service (Amazon SNS) topics that you want the action to send a test notification to.</p>
-- @param _Role [Role] <p>The IAM Amazon Resource Name (ARN) for the role that you want Elastic Transcoder to test.</p>
-- @param _InputBucket [BucketName] <p>The Amazon S3 bucket that contains media files to be transcoded. The action attempts to read from this bucket.</p>
-- Required parameter: Role
-- Required parameter: InputBucket
-- Required parameter: OutputBucket
-- Required parameter: Topics
function M.TestRoleRequest(_OutputBucket, _Topics, _Role, _InputBucket, ...)
...
-- @param _Pipeline [Pipeline] <p>A section of the response body that provides information about the pipeline.</p>
function M.UpdatePipelineStatusResponse(_Pipeline, ...)
...
-- @param _PlayReadyDrm [PlayReadyDrm] <p>The DRM settings, if any, that you want Elastic Transcoder to apply to the output files associated with this playlist.</p>
-- @param _Format [PlaylistFormat] <p>The format of the output playlist. Valid formats include <code>HLSv3</code>, <code>HLSv4</code>, and <code>Smooth</code>.</p>
function M.CreateJobPlaylist(_HlsContentProtection, _OutputKeys, _Name, _PlayReadyDrm, _Format, ...)
...
-- @param _Container [JobContainer] <p>The container type for the input file. If you want Elastic Transcoder to automatically detect the container type of the input file, specify <code>auto</code>. If you want to specify the container type for the input file, enter one of the following values: </p> <p> <code>3gp</code>, <code>aac</code>, <code>asf</code>, <code>avi</code>, <code>divx</code>, <code>flv</code>, <code>m4a</code>, <code>mkv</code>, <code>mov</code>, <code>mp3</code>, <code>mp4</code>, <code>mpeg</code>, <code>mpeg-ps</code>, <code>mpeg-ts</code>, <code>mxf</code>, <code>ogg</code>, <code>vob</code>, <code>wav</code>, <code>webm</code> </p>
-- @param _TimeSpan [TimeSpan] <p>Settings for clipping an input. Each input can have different clip settings.</p>
-- @param _InputCaptions [InputCaptions] <p>You can configure Elastic Transcoder to transcode captions, or subtitles, from one format to another. All captions must be in UTF-8. Elastic Transcoder supports two types of captions:</p> <ul> <li> <p> <b>Embedded:</b> Embedded captions are included in the same file as the audio and video. Elastic Transcoder supports only one embedded caption per language, to a maximum of 300 embedded captions per file.</p> <p>Valid input values include: <code>CEA-608 (EIA-608</code>, first non-empty channel only), <code>CEA-708 (EIA-708</code>, first non-empty channel only), and <code>mov-text</code> </p> <p>Valid outputs include: <code>mov-text</code> </p> <p>Elastic Transcoder supports a maximum of one embedded format per output.</p> </li> <li> <p> <b>Sidecar:</b> Sidecar captions are kept in a separate metadata file from the audio and video data. Sidecar captions require a player that is capable of understanding the relationship between the video file and the sidecar file. Elastic Transcoder supports only one sidecar caption per language, to a maximum of 20 sidecar captions per file.</p> <p>Valid input values include: <code>dfxp</code> (first div element only), <code>ebu-tt</code>, <code>scc</code>, <code>smpt</code>, <code>srt</code>, <code>ttml</code> (first div element only), and <code>webvtt</code> </p> <p>Valid outputs include: <code>dfxp</code> (first div element only), <code>scc</code>, <code>srt</code>, and <code>webvtt</code>.</p> </li> </ul> <p>If you want ttml or smpte-tt compatible captions, specify dfxp as your output format.</p> <p>Elastic Transcoder does not support OCR (Optical Character Recognition), does not accept pictures as a valid input for captions, and is not available for audio-only transcoding. Elastic Transcoder does not preserve text formatting (for example, italics) during the transcoding process.</p> <p>To remove captions or leave the captions empty, set <code>Captions</code> to null. To pass through existing captions unchanged, set the <code>MergePolicy</code> to <code>MergeRetain</code>, and pass in a null <code>CaptionSources</code> array.</p> <p>For more information on embedded files, see the Subtitles Wikipedia page.</p> <p>For more information on sidecar files, see the Extensible Metadata Platform and Sidecar file Wikipedia pages.</p>
-- @param _Encryption [Encryption] <p>The encryption settings, if any, that are used for decrypting your input files. If your input file is encrypted, you must specify the mode that Elastic Transcoder uses to decrypt your file.</p>
...
-- @param _Key [LongKey] <p> The name of the file to transcode. Elsewhere in the body of the JSON block is the the ID of the pipeline to use for processing the job. The <code>InputBucket</code> object in that pipeline tells Elastic Transcoder which Amazon S3 bucket to get the file from. </p> <p>If the file name includes a prefix, such as <code>cooking/lasagna.mpg</code>, include the prefix in the key. If the file isn't in the specified bucket, Elastic Transcoder returns an error.</p>
-- @param _AspectRatio [AspectRatio] <p> The aspect ratio of the input file. If you want Elastic Transcoder to automatically detect the aspect ratio of the input file, specify <code>auto</code>. If you want to specify the aspect ratio for the output file, enter one of the following values: </p> <p> <code>1:1</code>, <code>4:3</code>, <code>3:2</code>, <code>16:9</code> </p> <p> If you specify a value other than <code>auto</code>, Elastic Transcoder disables automatic detection of the aspect ratio. </p>
-- @param _DetectedProperties [DetectedProperties] <p>The detected properties of the input file.</p>
-- @param _Resolution [Resolution] <p>This value must be <code>auto</code>, which causes Elastic Transcoder to automatically detect the resolution of the input file.</p>
-- @param _Interlaced [Interlaced] <p>Whether the input file is interlaced. If you want Elastic Transcoder to automatically detect whether the input file is interlaced, specify <code>auto</code>. If you want to specify whether the input file is interlaced, enter one of the following values:</p> <p> <code>true</code>, <code>false</code> </p> <p>If you specify a value other than <code>auto</code>, Elastic Transcoder disables automatic detection of interlacing.</p>
function M.JobInput(_Container, _TimeSpan, _InputCaptions, _Encryption, _FrameRate, _Key, _AspectRatio, _DetectedProperties, _Resolution, _Interlaced, ...)
...
-- @param _NextPageToken [Id] <p>A value that you use to access the second and subsequent pages of results, if any. When the pipelines fit on one page or when you've reached the last page of results, the value of <code>NextPageToken</code> is <code>null</code>.</p>
-- @param _Pipelines [Pipelines] <p>An array of <code>Pipeline</code> objects.</p>
function M.ListPipelinesResponse(_NextPageToken, _Pipelines, ...)
...
-- @param _Id [Id] <p>The identifier of the job that you want to cancel.</p> <p>To get a list of the jobs (including their <code>jobId</code>) that have a status of <code>Submitted</code>, use the <a>ListJobsByStatus</a> API action.</p>
-- Required parameter: Id
function M.CancelJobRequest(_Id, ...)
