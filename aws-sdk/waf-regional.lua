...
--  
-- @param _WebACLId [ResourceId] <p>The unique identifier (ID) of the web ACL for which to list the associated resources.</p>
-- Required parameter: WebACLId
function M.ListResourcesForWebACLRequest(_WebACLId, ...)
...
--  
-- @param _ResourceArns [ResourceArns] <p>An array of ARNs (Amazon Resource Names) of the resources associated with the specified web ACL. An array with zero elements is returned if there are no resources associated with the web ACL.</p>
function M.ListResourcesForWebACLResponse(_ResourceArns, ...)
...
--  
-- @param _ResourceArn [ResourceArn] <p>The ARN (Amazon Resource Name) of the resource from which the web ACL is being removed.</p>
-- Required parameter: ResourceArn
function M.DisassociateWebACLRequest(_ResourceArn, ...)
...
-- @param _message [errorMessage] 
function M.WAFUnavailableEntityException(_message, ...)
...
--  
-- @param _ResourceArn [ResourceArn] <p>The ARN (Amazon Resource Name) of the resource for which to get the web ACL.</p>
-- Required parameter: ResourceArn
function M.GetWebACLForResourceRequest(_ResourceArn, ...)
...
-- @param _WebACLId [ResourceId] <p>A unique identifier (ID) for the web ACL.</p>
-- Required parameter: WebACLId
-- Required parameter: ResourceArn
function M.AssociateWebACLRequest(_ResourceArn, _WebACLId, ...)
...
--  
-- @param _WebACLSummary [WebACLSummary] <p>Information about the web ACL that you specified in the <code>GetWebACLForResource</code> request. If there is no associated resource, a null WebACLSummary is returned.</p>
function M.GetWebACLForResourceResponse(_WebACLSummary, ...)
	assert(select("#", ...) == 0, "Too many arguments when creating GetWebACLForResourceResponse")
	local t = { 
		["WebACLSummary"] = _WebACLSummary,
	}
...
-- @return response
-- @return error_message
function M.AssociateWebACLSync(...)
	local co = coroutine.running()
	assert(co, "You must call this function from within a coroutine")
	M.AssociateWebACLAsync(..., function(response, error_message)
		assert(coroutine.resume(co, response, error_message))
	end)
	return coroutine.yield()
end
...
-- @return response
-- @return error_message
function M.GetWebACLForResourceSync(...)
	local co = coroutine.running()
	assert(co, "You must call this function from within a coroutine")
	M.GetWebACLForResourceAsync(..., function(response, error_message)
		assert(coroutine.resume(co, response, error_message))
	end)
	return coroutine.yield()
end
...
-- @return response
-- @return error_message
function M.ListResourcesForWebACLSync(...)
	local co = coroutine.running()
	assert(co, "You must call this function from within a coroutine")
	M.ListResourcesForWebACLAsync(..., function(response, error_message)
		assert(coroutine.resume(co, response, error_message))
	end)
	return coroutine.yield()
end
...
-- @return response
-- @return error_message
function M.DisassociateWebACLSync(...)
	local co = coroutine.running()
	assert(co, "You must call this function from within a coroutine")
	M.DisassociateWebACLAsync(..., function(response, error_message)
		assert(coroutine.resume(co, response, error_message))
	end)
	return coroutine.yield()
end
